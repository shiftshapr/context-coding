...
3. Start with `README.md` or `02_TOOLING_OVERVIEW.md`
...
1. Read `02_TOOLING_OVERVIEW.md` to understand the tools
2. Read `03_WORKFLOW_GUIDE.md` to learn the workflow
3. Follow `04_SETUP_AND_ONBOARDING.md` for detailed setup
...
```bash
# Read in this order:
1. 02_TOOLING_OVERVIEW.md      # Understand all tools
2. 03_WORKFLOW_GUIDE.md         # Complete workflow process
3. 04_SETUP_AND_ONBOARDING.md   # Detailed setup instructions
4. 05_SYSTEM_PROMPT.md          # Orchestration prompt template
5. 07a_CURSORRULES_GENERIC.md   # Universal rules
6. 09_JAUMEMORY_CONTEXT_QUICKSTART.md  # Memory management
```
...
- **02_TOOLING_OVERVIEW.md** - Complete guide to all tools (start here)
- **03_WORKFLOW_GUIDE.md** - Step-by-step workflow process
- **04_SETUP_AND_ONBOARDING.md** - Detailed setup instructions
- **05_SYSTEM_PROMPT.md** - The orchestration prompt template
- **07a_CURSORRULES_GENERIC.md** - Universal project rules
- **07b_CURSORRULES_EXTENSION_EXAMPLE.md** - Extension-specific rules
- **08_DEFAULT_WORKFLOW_MANIFEST.md** - 10-agent workflow definition
- **09_JAUMEMORY_CONTEXT_QUICKSTART.md** - Memory management guide
- **10_AGENT_DESCRIPTIONS.md** - Agent roles and responsibilities
...
- [ ] Read `02_TOOLING_OVERVIEW.md`
- [ ] Read `03_WORKFLOW_GUIDE.md`
- [ ] Ready to follow `04_SETUP_AND_ONBOARDING.md` for full setup
...
**If you're stuck**:
1. Check `04_SETUP_AND_ONBOARDING.md` for detailed instructions
2. Ask Cursor: "Help me set up the contextcoding repository"
3. Review `02_TOOLING_OVERVIEW.md` for tool explanations
...
- Start with `02_TOOLING_OVERVIEW.md`
- Then read `03_WORKFLOW_GUIDE.md`
- Then follow `04_SETUP_AND_ONBOARDING.md`
